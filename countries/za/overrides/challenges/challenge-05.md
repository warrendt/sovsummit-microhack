# Challenge 5 — Confidential AKS for ${country.name} fraud-detection inference

[Previous Challenge](challenge-04.md) — **[Home](../Readme.md)** — Next: [Challenge 6](challenge-06.md)

## The situation

${country.scenarios.financial_tenant} has trained a fraud-detection model
...
- [ ] An AKS cluster exists in `${country.azure.primary_region}` with at
...
- **AKS preview features:** confidential containers / Kata-CC may be in
  preview on `${country.azure.primary_region}`. Stick to confidential

// Foundation resources for the ${country.name} edition: Log Analytics, Premium
...
resource kv 'Microsoft.KeyVault/vaults@2023-07-01' = {
  ...
  properties: {
    sku: {
      ...
      name: '${country.azure.cmk_hsm_sku}'
    }
...
resource sa 'Microsoft.Storage/storageAccounts@2023-05-01' = {
  ...
  location: location
  tags: tags
  sku: { name: 'Standard_GRS' } // GRS pairs to ${country.azure.paired_region} (in-country)
  kind: 'StorageV2'
  identity: {
    type: 'UserAssigned'

...
> Walkthrough for `${country.summit_edition}` / Challenge SA-01.
...
| Policy | Effect | Why |
|---|---|---|
| Allowed locations | Deny | POPIA s.72 — no resources outside ${country.name}. |
...
| Diagnostic settings to a Log Analytics workspace in ${country.azure.primary_region} | DeployIfNotExists | Keeps telemetry in-country. |
